    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="bg-gradient-to-br from-pink-500/10 to-pink-500/5 border border-pink-500/30 rounded-xl p-6 backdrop-blur-sm shadow-lg shadow-pink-500/20">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-pink-400">{array.length}</p>
              </div>
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-gradient-to-br from-slate-900/80 to-slate-800/80 border border-cyan-500/20 rounded-xl p-6 backdrop-blur-sm shadow-2xl"
        >
          <h3 className="text-cyan-300 font-semibold mb-4 text-lg">Select Algorithm</h3>
              ...
              return (
                ...
                >
                  ...
                  <p className={`text-sm font-medium ${
                    selectedAlgorithm === algo.id ? 'text-cyan-300' : 'text-slate-400'
                  }`}>
                    {algo.name}
                  </p>
                  {selectedAlgorithm === algo.id && (
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-slate-900/80 to-slate-800/80 border border-purple-500/20 rounded-xl p-8 backdrop-blur-sm shadow-2xl min-h-[400px]"
        >
            ...
            <AnimatePresence mode="popLayout">
              {array.map((element, index) => (
                <motion.div
                  ...
                  transition={{
                    layout: { type: 'spring', bounce: 0.3, duration: 0.5 },
                    height: { type: 'spring', bounce: 0.2, duration: 0.4 },
                  }}
                ...
                >
                  {element.trail && (
                    <motion.div
                      ...
                      style={{
                        background: 'linear-gradient(to top, rgba(168, 85, 247, 0.4), rgba(192, 132, 252, 0.4))',
                        filter: 'blur(8px)',
                      }}
                    />
                  )}
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-slate-900/80 to-slate-800/80 border border-pink-500/20 rounded-xl p-6 backdrop-blur-sm shadow-2xl space-y-6"
        >
          <div className="flex flex-wrap gap-4 justify-center">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white font-semibold px-8 py-6 text-lg shadow-lg shadow-cyan-500/30 disabled:opacity-50"
              >
                {isPlaying ? (
                  <>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                onClick={resetArray}
                disabled={isPlaying}
                className="bg-gradient-to-r from-pink-500 to-orange-500 hover:from-pink-600 hover:to-orange-600 text-white font-semibold px-8 py-6 text-lg shadow-lg shadow-pink-500/30 disabled:opacity-50"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <label className="text-cyan-300 font-medium">Speed</label>
                <span className="text-cyan-400 font-bold">{speed[0]}%</span>
              </div>
              <Slider
                value={speed}
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <label className="text-purple-300 font-medium">Array Size</label>
                <span className="text-purple-400 font-bold">{arraySize[0]}</span>
              </div>
              <Slider
                value={arraySize}
