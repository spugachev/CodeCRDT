                  ...
                  {formData.password && (
                    ...
                    >
                      ...
                      <p className={`text-xs font-medium ${
                        calculatePasswordStrength(formData.password).strength < 30 ? 'text-red-500' :
                        calculatePasswordStrength(formData.password).strength < 60 ? 'text-orange-500' :
                        calculatePasswordStrength(formData.password).strength < 80 ? 'text-yellow-500' :
                        'text-green-500'
                      }`}>
