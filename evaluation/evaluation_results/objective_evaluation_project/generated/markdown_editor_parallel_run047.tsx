...
const MarkdownComponents = {
  ...
  blockquote: ({ children }: any) => (
    <blockquote className="border-l-4 border-yellow-500 bg-[#2d2d2d] pl-4 py-3 my-4 italic text-gray-400 rounded-r">
      {children}
    </blockquote>
  ),
  hr: () => (
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold text-blue-400">{markdown.length.toLocaleString()}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-500 uppercase tracking-wider">Words</span>
                <span className="text-sm font-semibold text-purple-400">
                  {markdown.trim() ? markdown.trim().split(/\s+/).length.toLocaleString() : 0}
                </span>
              </div>
              <div className="flex items-center gap-2">
