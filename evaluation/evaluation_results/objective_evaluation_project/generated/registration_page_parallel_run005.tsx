...
const getPasswordStrength = (password: string): { strength: number; label: string; color: string } => {
  ...
  const strengthMap = [
    ...
    { strength: 1, label: 'Fair', color: 'bg-orange-500' },
    { strength: 2, label: 'Good', color: 'bg-yellow-500' },
    { strength: 3, label: 'Strong', color: 'bg-green-500' }
  ];
...
export default function RegistrationPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 relative overflow-hidden">
      ...
      />
      <motion.div
        className="absolute bottom-40 right-1/3 w-72 h-72 bg-yellow-400 rounded-full mix-blend-multiply filter blur-xl opacity-60"
        animate={{
          x: [0, -80, 0],
          y: [0, 80, 0],
          scale: [1, 1.25, 1],
            ...
            {isSuccess ? (
              ...
              >
                <motion.div
                  ...
                  className="mx-auto w-20 h-20 bg-gradient-to-br from-green-400 to-rald-500 rounded-full flex items-center justify-center mb-6"
                >
                  <CheckCircle2 className="w-10 h-10 text-white" />
                </motion.div>
                <h3 className="text-2xl font-bold text-gray-800 mb-2">Registration Successful!</h3>
                <p className="text-gray-600">Welcome aboard! Your account has been created.</prald-500 rounded-full flex items-center justify-center mb-6"
                >
