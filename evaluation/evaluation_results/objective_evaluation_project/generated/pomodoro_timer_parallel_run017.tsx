                ...
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 320 320">
                  ...
                  <defs>
                    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" className={`text-${currentMode === 'work' ? 'rose' : currentMode === 'shortBreak' ? 'cyan' : 'emerald'}-500`} stopColor="currentColor" />
                      <stop offset="50%" className={`text-${currentMode === 'work' ? 'pink' : currentMode === 'shortBreak' ? 'blue' : 'teal'}-500`} stopColor="currentColor" />
                      <stop offset="100%" className={`text-${currentMode === 'work' ? 'purple' : currentMode === 'shortBreak' ? 'indigo' : 'cyan'}-500`} stopColor="currentColor" />
                    </linearGradient>
                  </defs>
                </svg>
            ...
            {showSettings && (
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="short-break" className="text-white text-lg">
                      Short Break (minutes)
                    </Label>
                    <Input
                      id="short-break"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="long-break" className="text-white text-lg">
                      Long Break (minutes)
                    </Label>
                    <Input
                      id="long-break"
            ...
            {showCompletion && (
              ...
              >
                ...
                <motion.div
                  ...
                  className="pointer-events-auto backdrop-blur-xl bg-white/20 rounded-3xl p-12 shadow-2xl border border-white/30"
                >
                  <motion.div
                    animate={{ 
                      scale: [1, 1.2, 1],
