...
const MarkdownComponents = {
  ...
  code: ({ inline, className, children, ...props }: any) => {
    ...
    return !inline && language ? (
      ...
      <code className="bg-[#161b22] text-pink-400 px-2 py-1 rounded text-sm font-mono border border-[#30363d]" {...props}>
        {children}
      </code>
    );
  },
  ...
  blockquote: ({ children }: any) => (
    <blockquote className="border-l-4 border-blue-500 pl-4 py-2 my-4 bg-[#161b22] text-gray-300 italic rounded-r">
      {children}
    </blockquote>
  ),
  hr: () => (
            ...
            {toolbarButtons.map((button, index) => (
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    className="absolute inset-0 rounded-md bg-gradient-to-r from-blue-400/0 to-purple-500/0 group-hover:from-blue-400/10 group-hover:to-purple-500/10"
                    initial={false}
