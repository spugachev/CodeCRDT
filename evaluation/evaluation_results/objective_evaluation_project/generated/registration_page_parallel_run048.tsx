                    ...
                    >
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className={`font-medium ${
                          getPasswordStrength(formData.password).label === 'Weak' ? 'text-red-500' :
                          getPasswordStrength(formData.password).label === 'Fair' ? 'text-orange-500' :
                          getPasswordStrength(formData.password).label === 'Good' ? 'text-yellow-500' :
                          'text-green-500'
                        }`}>
                        ...
                        {[0, 1, 2, 3].map((index) => (
                          <motion.div
                            ...
                            className={`h-1 flex-1 rounded-full ${
                              index <= getPasswordStrength(formData.password).strength - 1
