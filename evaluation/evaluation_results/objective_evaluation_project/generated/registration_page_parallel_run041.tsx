                    ...
                    >
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className={`font-medium ${
                          calculatePasswordStrength(formData.password).strength === 1 ? 'text-red-500' :
                          calculatePasswordStrength(formData.password).strength === 2 ? 'text-yellow-500' :
                          'text-green-500'
                        }`}>
                        ...
                        {[1, 2, 3].map((bar) => (
                          <motion.div
                            ...
                            className={`h-1.5 flex-1 rounded-full ${
                              bar <= calculatePasswordStrength(formData.password).strength
