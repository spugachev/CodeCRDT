      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <AnimatePresence>
          {particles.map((particle) => (
            <motion.div
              key={particle.id}
              className={`absolute rounded-full bg-gradient-to-br ${timerModes[currentMode].colors} opacity-20 blur-sm`}
              style={{
                left: `${particle.x}%`,
                top: `${particle.y}%`,
                width: particle.size,
        ...
        >
          <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 shadow-2xl border border-white/20">
            ...
            <div className="flex flex-col items-center gap-4">
              <p className="text-white/80 text-sm font-medium">Completed Pomodoros</p>
              ...
              <p className="text-white/60 text-xs">
                {completedPomodoros === 0 && "Start your first pomodoro!"}
                {completedPomodoros > 0 && completedPomodoros < settings.longBreakInterval && 
                  `${settings.longBreakInterval - completedPomodoros} until long break`}
                {completedPomodoros > 0 && completedPomodoros % settings.longBreakInterval === 0 && 
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 text-lg mb-6">
                  {currentMode === 'work' 
                    ? `You've completed a pomodoro session! Time for a ${completedPomodoros % settings.longBreakInterval === 0 ? 'long' : 'short'} break.`
              ...
              {[...Array(8)].map((_, i) => (
                ...
                >
                  <div className="w-full h-full bg-yellow-400 rotate-45 transform" />
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
