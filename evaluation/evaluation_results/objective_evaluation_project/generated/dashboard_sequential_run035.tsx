                    ...
                    <tbody>
                      {tableData.map((row, index) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-2 md:px-4 text-sm font-medium text-gray-900 dark:text-white">{row.revenue}</td>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm font-medium text-gray-900 dark:text-white">5.2</span>
                        </div>
                        <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-2">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={index} className="flex items-center gap-3">
                          <div className="w-32 text-sm text-gray-600 dark:text-gray-400">{item.stage}</div>
                          <div className="flex-1 bg-gray-200 dark:bg-gray-800 rounded-full h-8 relative overflow-hidden">
                            <motion.div
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    { name: 'Marketing Campaign Results', date: '2024-01-01', size: '1.2 MB' },
                  ].map((report, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ delay: index * 0.1 }}
                      className="flex flex-col sm:flex-row sm:items-center justify-between p-4 border dark:border-gray-800 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors gap-3"
                    >
                      ...
                      <Button variant="outline" size="sm" className="dark:border-gray-700 w-full sm:w-auto">
                        Download
                      </Button>
                    </motion.div>
                  ))}
