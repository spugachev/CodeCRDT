...
const MarkdownComponents = {
  ...
  code: ({ inline, className, children, ...props }: any) => {
    ...
    return !inline && match ? (
      <div className="my-4 rounded-lg overflow-hidden border border-[#30363d]">
        <div className="bg-[#1e1e1e] px-4 py-2 text-xs text-gray-400 border-b border-[#30363d] font-mono">
          {match[1]}
        </div>
        <SyntaxHighlighter
          style={vscDarkPlus}
  ...
  td: ({ children }: any) => (
    <td className="px-4 py-2 text-gray-300 border-r border-[#30363d] last:border-r-0">
      {children}
    </td>
  )
};
