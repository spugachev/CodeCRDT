...
const MarkdownComponents = {
  ...
  code: ({ inline, className, children, ...props }: any) => {
    ...
    return !inline && match ? (
      ...
      <code className="bg-[#2d2d2d] text-pink-400 px-2 py-1 rounded text-sm font-mono border border-gray-700" {...props}>
        {children}
      </code>
    );
  },
  ...
  blockquote: ({ children }: any) => (
    <blockquote className="border-l-4 border-purple-500 bg-[#2d2d2d] pl-4 py-3 my-4 italic text-gray-400 rounded-r">
      {children}
    </blockquote>
  ),
  hr: () => (
