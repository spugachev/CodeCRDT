                  ...
                  {formData.password && (
                    ...
                    >
                      ...
                      <div className="flex gap-1">
                        ...
                        <motion.div
                          initial={{ scaleX: 0 }}
                          animate={{ scaleX: formData.password.length >= 4 ? 1 : 0 }}
                          transition={{ duration: 0.3 }}
                          className={`h-1 flex-1 rounded-full ${
                            formData.password.length >= 4 ? 'bg-orange-500' : 'bg-gray-200'
                          }`}
                        />
                        <motion.div
                          initial={{ scaleX: 0 }}
                          animate={{ scaleX: formData.password.length >= 8 ? 1 : 0 }}
                          transition={{ duration: 0.3 }}
                          className={`h-1 flex-1 rounded-full ${
                        ...
                        <motion.div
                          initial={{ scaleX: 0 }}
                          animate={{ scaleX: formData.password.length >= 8 && /(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/.test(formData.password) ? 1 : 0 }}
                          transition={{ duration: 0.3 }}
                          className={`h-1 flex-1 rounded-full ${
                            formData.password.length >= 8 && /(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/.test(formData.password) ? 'bg-green-500' : 'bg-gray-200'
                          }`}
                        />
                      </div>
                    </motion.div>
