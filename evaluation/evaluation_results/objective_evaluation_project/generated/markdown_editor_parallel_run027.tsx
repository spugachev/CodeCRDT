...
const MarkdownComponents = {
  h1: ({ children }: any) => (
    <h1 className="text-4xl font-bold mb-6 mt-8 pb-3 border-b border-[#30363d] text-gray-100">
      {children}
    </h1>
  ),
  h2: ({ children }: any) => (
    <h2 className="text-3xl font-bold mb-4 mt-6 pb-2 border-b border-[#30363d] text-gray-100">
      {children}
    </h2>
  ),
  h3: ({ children }: any) => (
    <h3 className="text-2xl font-bold mb-3 mt-5 text-gray-100">
      {children}
    </h3>
  ),
  h4: ({ children }: any) => (
    <h4 className="text-xl font-bold mb-2 mt-4 text-gray-100">
      {children}
    </h4>
  ),
  h5: ({ children }: any) => (
  ...
  hr: () => (
    <hr className="my-8 border-t-2 border-[#30363d]" />
  ),
  img: ({ src, alt }: any) => (
    <img
      src={src}
