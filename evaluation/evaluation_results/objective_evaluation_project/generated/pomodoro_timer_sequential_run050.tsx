        ...
        <AnimatePresence>
          {showSettings && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 20 }}
              className="mt-8 backdrop-blur-2xl bg-white/5 rounded-2xl p-6 border border-white/10 w-96"
            >
              <h3 className="text-white text-xl font-semibold mb-4">Timer Settings</h3>
