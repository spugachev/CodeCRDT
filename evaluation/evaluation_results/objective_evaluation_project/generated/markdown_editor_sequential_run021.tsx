  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-gray-100">
      ...
      <style jsx global>{`
        ...
        .prose-custom ul li.unordered::before {
          content: "•";
          position: absolute;
          left: 0;
          color: #58a6ff;
        ...
        .prose-custom ol li.ordered::before {
        ...
        .prose-custom::-webkit-scrollbar-thumb:hover {
          background: #484f58;
        }
      `}</style>
    </div>
