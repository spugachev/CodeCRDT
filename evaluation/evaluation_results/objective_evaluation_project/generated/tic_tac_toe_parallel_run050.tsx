...
export default function TicTacToe() {
  ...
  const handleCellClick = useCallback((index: number) => {
    // Ignore if game is over, cell is occupied, or AI is thinking
          ...
          >
            {status === 'playing' && (
              <div className="flex items-center justify-center gap-2">
                ...
                {currentPlayer === 'X' ? (
                  ...
                  <Circle className="w-6 h-6 text-red-600 animate-pulse" />
                )}
              </div>
            )}
            {status === 'won' && (
            ...
            {status === 'draw' && (
              ...
              >
                ...
                <p className="text-sm text-gray-600">Well played!</p>
              </motion.div>
            )}
          </motion.div>
              ...
              <motion.button
                ...
                className={`
                  ...
                  ${cell !== null || status !== 'playing' || isAiThinking
                    ...
                    : 'cursor-pointer bg-white hover:bg-gray-50 hover:border-purple-400'
                  }
                  ${status === 'playing' ? 'border-gray-300' : 'border-gray-200'}
