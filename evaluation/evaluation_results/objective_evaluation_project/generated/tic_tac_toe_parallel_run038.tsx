...
export default function TicTacToe() {
  ...
  const handleCellClick = useCallback((index: number) => {
    // Don't allow moves if game is over, AI is thinking, or cell is occupied
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 space-y-2">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• You play as <span className="font-semibold text-blue-600">X</span>, AI plays as <span className="font-semibold text-red-600">O</span></li>
