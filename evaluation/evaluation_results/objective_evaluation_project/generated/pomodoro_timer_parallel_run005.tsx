          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 shadow-2xl border border-white/20">
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center gap-2 flex-wrap">
                {Array.from({ length: Math.max(completedPomodoros, 4) }).map((_, index) => (
                  <motion.div
                    key={index}
                    initial={{ scale: 0, opacity: 0 }}
                    animate={{ 
                      scale: index < completedPomodoros ? 1 : 0.7,
                    ...
                    className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm
                      ...
                      ${index === completedPomodoros - 1 ? 'ring-4 ring-white/50' : ''}
                    `}
                  >
                    {index + 1}
                  </motion.div>
          ...
          <AnimatePresence>
            {showSettings && (
              <motion.div
                ...
                className="mt-6 backdrop-blur-xl bg-white/10 rounded-2xl p-6 shadow-2xl border border-white/20"
              >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-lg bg-white/20 border border-white/30 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 backdrop-blur-sm"
                    />
                  </div>
              ...
              >
                ...
                >
                  <Button
                    size="lg"
                    onClick={() => setShowCompletion(false)}
                    className="bg-white text-orange-500 hover:bg-white/90 font-semibold px-8 py-6 text-lg"
                  >
                    Continue
                  </Button>
                </motion.div>
