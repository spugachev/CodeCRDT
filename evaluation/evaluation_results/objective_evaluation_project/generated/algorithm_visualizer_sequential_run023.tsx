    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          ...
          <div className="bg-gradient-to-br from-pink-500/10 to-orange-500/10 border border-pink-500/30 rounded-xl p-6 backdrop-blur-sm shadow-lg shadow-pink-500/20">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <Slider
                ...
                max={100}
                step={1}
                className="[&_[role=slider]]:bg-cyan-400 [&_[role=slider]]:border-cyan-300 [&_[role=slider]]:shadow-lg [&_[role=slider]]:shadow-cyan-400/50"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <Slider
                ...
                step={1}
                disabled={isPlaying}
                className="[&_[role=slider]]:bg-pink-400 [&_[role=slider]]:border-pink-300 [&_[role=slider]]:shadow-lg [&_[role=slider]]:shadow-pink-400/50"
              />
            </div>
          </div>
