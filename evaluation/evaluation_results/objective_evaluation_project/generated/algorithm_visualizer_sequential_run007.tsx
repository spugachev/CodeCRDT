                ...
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: element.isSorted
                      ...
                      : element.isComparing
                      ? '0 0 25px rgba(236, 72, 153, 0.7), 0 0 50px rgba(236, 72, 153, 0.3)'
                      : '0 0 15px rgba(6, 182, 212, 0.5), 0 0 30px rgba(6, 182, 212, 0.2)',
                  }}
                >
                  {element.trail && (
                    <motion.div
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold px-8 py-6 text-lg rounded-xl shadow-lg shadow-cyan-500/50 border-2 border-cyan-400/50"
              >
                {isPlaying ? (
                  <>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                onClick={resetArray}
                className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold px-8 py-6 text-lg rounded-xl shadow-lg shadow-purple-500/50 border-2 border-purple-400/50"
              >
