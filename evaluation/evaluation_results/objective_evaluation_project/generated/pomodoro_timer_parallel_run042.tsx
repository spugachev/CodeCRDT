...
export default function PomodoroTimer() {
  ...
  useEffect(() => {
    // Initialize audio element for completion sound
    audioRef.current = new Audio('data:audio/wav;base64,');
  }, []);
  ...
  useEffect(() => {
    ...
    setParticles(generatedParticles);2,
      duration: Math.random() * 20 + 10,
      delay: Math.random() * 5
    }));
  ...
  return (
    <div className={`min-h-screen relative overflow-hidden transition-all duration-1000 ${timerModes[currentMode].gradient}`}>
      ...
      <AnimatePresence>
        {showCompletion && (
          <motion.div
            ...
            className="absolute inset-0 flex items-center justify-center z-50 bg-black/50 backdrop-blur-md"
          >
            <motion.div
              initial={{ y: 50 }}
              animate={{ y: 0 }}
            ...
            >
              ...
              <p className="text-2xl text-white/80">
                {currentMode === 'work' ? 'Time for a break' : 'Ready to focus?'}
              </p>
            </motion.div>
          </motion.div>
        )}
      ...
      <audio ref={audioRef} /></parameter>e/30 backdrop-blur-sm"
            style={{
              left: `${particle.x}%`,
              top: `${particle.y}%`,
              width: particle.size,
              ...
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <div className="text-xl text-white/70 capitalize">
                    {currentMode === 'shortBreak' ? 'Short Break' : currentMode === 'longBreak' ? 'Long Break' : 'Work Time'}
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/30 backdrop-blur-sm"
                    />
                  </div>
            ...
            {showCompletion && (
              ...
              >
                <motion.div
                  ...
                  className="bg-white/95 backdrop-blur-xl rounded-3xl p-12 shadow-2xl border-4 border-white max-w-md mx-4"
                ...
                >
                  ...
                  >
                    ...
                    <h2 className={`text-4xl font-bold bg-gradient-to-r ${timerModes[currentMode].colors} bg-clip-text text-transparent`}>
                      {currentMode === 'work' ? 'Great Work!' : 'Break Complete!'}
                    </h2>
                  </motion.div>
                  ...
                  <Button
                    onClick={() => setShowCompletion(false)}
                    className={`w-full bg-gradient-to-r ${timerModes[currentMode].colors} text-white text-lg py-6 hover:opacity-90 transition-opacity`}
                  >
                    Continue
                  </Button>
                </motion.div>
