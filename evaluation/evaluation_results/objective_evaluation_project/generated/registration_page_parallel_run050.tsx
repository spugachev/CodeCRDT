                    ...
                    >
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className={`font-medium ${
                          getPasswordStrength(formData.password).strength === 0 ? 'text-red-500' :
                          getPasswordStrength(formData.password).strength === 1 ? 'text-orange-500' :
                        ...
                        {[0, 1, 2, 3].map((index) => (
                          <motion.div
                            ...
                            className={`h-1.5 flex-1 rounded-full transition-colors duration-300 ${
                              index <= getPasswordStrength(formData.password).strength
