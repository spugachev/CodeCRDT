  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h3: ({ node, ...props }) => (
          <h3 className="text-2xl font-bold mb-2 mt-4 text-green-400" {...props} />
        ),
        h4: ({ node, ...props }) => (
          <h4 className="text-xl font-bold mb-2 mt-3 text-yellow-400" {...props} />
        ),
        h5: ({ node, ...props }) => (
          <h5 className="text-lg font-bold mb-2 mt-3 text-pink-400" {...props} />
        ),
        h6: ({ node, ...props }) => (
          <h6 className="text-base font-bold mb-2 mt-3 text-cyan-400" {...props} />
        ),
        p: ({ node, ...props }) => (
        ...
        code: ({ node, inline, className, children, ...props }: any) => {
          ...
          return !inline && language ? (
            <div className="my-4 rounded-lg overflow-hidden border border-[#30363d]">
              <div className="bg-[#1e1e1e] px-4 py-2 text-xs text-gray-400 border-b border-[#30363d] flex items-center justify-between">
        ...
        th: ({ node, ...props }) => (
          <th className="border border-[#30363d] px-4 py-2 text-left font-bold text-purple-400" {...props} />
        ),
        td: ({ node, ...props }) => (
