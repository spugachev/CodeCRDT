    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 border border-cyan-500/20 rounded-2xl p-8 backdrop-blur-sm shadow-2xl shadow-cyan-500/10"
        >
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 border border-purple-500/20 rounded-2xl p-8 backdrop-blur-sm shadow-2xl shadow-purple-500/10 space-y-8"
        >
          {/* Algorithm Selection */}
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {ALGORITHMS.map((algo) => (
                ...
                >
                  <algo.icon className="w-6 h-6 mx-auto mb-2 text-purple-400" />
                  <p className="text-purple-300 font-medium text-sm">{algo.name}</p>
                </motion.button>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <Slider
                ...
                step={1}
                disabled={isPlaying}
                className="[&_[role=slider]]:bg-cyan-500 [&_[role=slider]]:border-cyan-400 [&_[role=slider]]:shadow-lg [&_[role=slider]]:shadow-cyan-500/50"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <Slider
                ...
                step={1}
                disabled={isPlaying}
                className="[&_[role=slider]]:bg-pink-500 [&_[role=slider]]:border-pink-400 [&_[role=slider]]:shadow-lg [&_[role=slider]]:shadow-pink-500/50"
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white px-8 py-6 text-lg font-semibold rounded-xl shadow-lg shadow-cyan-500/30 border-0"
              >
                {isPlaying ? (
                  <>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                onClick={resetArray}
                variant="outline"
                className="border-2 border-pink-500/50 bg-pink-500/10 hover:bg-pink-500/20 text-pink-300 px-8 py-6 text-lg font-semibold rounded-xl shadow-lg shadow-pink-500/20"
              >
