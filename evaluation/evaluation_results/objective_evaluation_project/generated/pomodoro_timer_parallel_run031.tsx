...
export default function PomodoroTimer() {
  ...
  const handleModeSwitch = useCallback((mode: 'work' | 'shortBreak' | 'longBreak') => {
    ...
    const newDuration = mode === 'work' 
      ...
      ? settings.shortBreakDuration * 60
      : settings.longBreakDuration * 60;
    setTimeLeft(newDuration);t newDuration = mode === 'work' 
      ? settings.workDuration * 60 
      : mode === 'shortBreak'
      ? settings.shortBreakDuration * 60
      : settings.longBreakDuration * 60;
...
<div className="flex gap-2 mb-8">
              ...
              <Button
                ...
                className={`flex-1 ${
                  currentMode === 'shortBreak'
                    ? 'bg-white text-cyan-500 hover:bg-white/90'
                    : 'text-white hover:bg-white/20'
                }`}
              >
                Short Break
              ...
              <Button
                ...
                className={`flex-1 ${
                  currentMode === 'longBreak'
                    ? 'bg-white text-emerald-500 hover:bg-white/90'
                    : 'text-white hover:bg-white/20'
                }`}
              >
                Long Break
            ...
            <div className="flex justify-center items-center my-12">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <div className="text-white/60 text-sm mt-2 uppercase tracking-widest">
            ...
            {showCompletion && (
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border-4 border-white pointer-events-auto"
                >
                  <div className="text-center">
                    ...
                    <h2 className={`text-3xl font-bold mb-2 bg-gradient-to-r ${timerModes[currentMode].colors} bg-clip-text text-transparent`}>
          ...
          <audio
            ref={audioRef}
            src="data:audio/wav;base64,"
          />
        </motion.div>
      </div>
    </div>
