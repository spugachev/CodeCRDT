...
export default function PomodoroTimer() {
  ...
  useEffect(() => {
    ...
    // Store the beep function in a way we can call it
    audioRef.current = { play: () => Promise.resolve(createBeep()) } as any;
  }, []);
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-4">
        <motion.div
          ...
          className="space-y-2"
        >
          <Label htmlFor="workDuration" className="text-white text-lg">
          ...
          <Input
            ...
            className="bg-white/10 border-white/30 text-white placeholder:text-white/50 backdrop-blur-sm text-lg"
          />
        </motion.div>
        ...
        <motion.div
          ...
          className="space-y-2"
        >
          <Label htmlFor="shortBreakDuration" className="text-white text-lg">
        ...
        <motion.div
          ...
          className="space-y-2"
        >
          <Label htmlFor="longBreakDuration" className="text-white text-lg">
        ...
        <motion.div
          ...
          className="space-y-2"
        >
          <Label htmlFor="longBreakInterval" className="text-white text-lg">
            ...
            {showCompletion && (
              ...
              >
                ...
                {Array.from({ length: 12 }).map((_, i) => (
                  <motion.div
                    key={`burst-${i}`}
                    className="absolute w-1 h-32 bg-gradient-to-t from-white/60 to-transparent"
                    style={{
                      left: '50%',
                      top: '50%',
