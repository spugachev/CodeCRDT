    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8">
        ...
        >
          {/* Glow Effect */}
          <div
            className={`absolute inset-0 rounded-full bg-gradient-to-r ${currentColors.primary} opacity-20 blur-3xl animate-pulse`}
          />
          ...
          <div className="relative backdrop-blur-2xl bg-white/5 rounded-full p-8 border border-white/10 shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <div className="text-slate-400 text-lg mt-2 capitalize">
        ...
        >
          <div className="text-center">
            <div className={`text-4xl font-bold bg-gradient-to-r ${currentColors.primary} bg-clip-text text-transparent`}>
              {completedPomodoros}
            </div>
            <div className="text-slate-400 text-sm mt-1">Completed Pomodoros</div>
          </div>
        </motion.div>
        ...
        <AnimatePresence>
          {showSettings && (
            ...
            >
              <div
                className="backdrop-blur-2xl bg-white/10 rounded-3xl p-8 border border-white/20 max-w-md w-full"
              ...
              >
                ...
                <Button
                  ...
                  className={`w-full mt-6 bg-gradient-to-r ${currentColors.primary} hover:opacity-90`}
                >
                  Save Settings
                </Button>
              </div>
          ...
          {showCompletion && (
            ...
            >
              <motion.div
                ...
                className={`text-9xl bg-gradient-to-r ${currentColors.primary} bg-clip-text text-transparent font-bold`}
              >
                ✓
              </motion.div>
