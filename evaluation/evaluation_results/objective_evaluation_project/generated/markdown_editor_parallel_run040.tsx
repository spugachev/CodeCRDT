...
export default function MarkdownEditor() {
  ...
  const handleToolbarAction = useCallback((action: string) => {
    ...
    // Handle different markdown actions
 ...
 <motion.div
                ...
                >
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="bg-[#252525] hover:bg-[#3d3d3d] text-gray-300 hover:text-white border border-transparent hover:border-blue-500/50 transition-all duration-200 group relative"
                    title={button.label}
                  >
                    ...
                    <motion.span
                      ...
                      className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-gray-900 text-xs px-2 py-1 rounded whitespace-nowrap pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                    >
                      {button.label}
                    </motion.span>
                  </Button>
