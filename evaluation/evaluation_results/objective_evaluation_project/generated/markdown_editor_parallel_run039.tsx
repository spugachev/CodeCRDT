  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h3: ({ node, ...props }) => (
          <h3 className="text-2xl font-bold mb-3 mt-4 text-gray-200" {...props} />
        ),
        h4: ({ node, ...props }) => (
          <h4 className="text-xl font-bold mb-2 mt-3 text-gray-200" {...props} />
        ),
        h5: ({ node, ...props }) => (
          <h5 className="text-lg font-bold mb-2 mt-3 text-gray-300" {...props} />
        ),
        h6: ({ node, ...props }) => (
          <h6 className="text-base font-bold mb-2 mt-2 text-gray-300" {...props} />
        ),
        p: ({ node, ...props }) => (
        ...
        ul: ({ node, ...props }) => (
          <ul className="list-disc list-inside mb-4 text-gray-300 space-y-1 ml-4" {...props} />
        ),
        ol: ({ node, ...props }) => (
          <ol className="list-decimal list-inside mb-4 text-gray-300 space-y-1 ml-4" {...props} />
        ),
        li: ({ node, ...props }) => (
        ...
        th: ({ node, ...props }) => (
          <th className="px-4 py-2 text-left text-gray-300 font-semibold" {...props} />
        ),
        td: ({ node, ...props }) => (
