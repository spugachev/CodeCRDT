                ...
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 320 320">
                  ...
                  <defs>
                    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                      ...
                      <stop offset="100%" stopColor="currentColor" className={`text-${currentMode === 'work' ? 'purple' : currentMode === 'shortBreak' ? 'indigo' : 'teal'}-400`} />
                    </linearGradient>
                  </defs>
                </svg>
          ...
          <AnimatePresence>
            {showCompletion && (
              ...
              >
                ...
                >
                  <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border-4 border-yellow-400">
                    <motion.div
