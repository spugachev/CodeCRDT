      ...
      <Card className="w-full max-w-md p-8 bg-white/95 backdrop-blur shadow-2xl">
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-2">Challenge the AI!</p>
          </div>
          ...
          >
            ...
            {isAiThinking && (
              ...
              >
                ...
                <span className="text-lg font-semibold text-gray-700">AI Thinking...</span>
              </motion.div>
            )}
            {status === 'won' && (
              <motion.div
              ...
              >
                {cell === 'X' && (
                  <motion.div
                    ...
                    transition={{ type: 'spring', stiffness: 200, damping: 15 }}
                  >
                    <X className="w-12 h-12 text-purple-600 stroke-[3]" />
                  </motion.div>
                )}
                {cell === 'O' && (
                  <motion.div
                    ...
                    transition={{ type: 'spring', stiffness: 200, damping: 15 }}
                  >
                    <Circle className="w-12 h-12 text-pink-600 stroke-[3]" />
                  </motion.div>
                )}
              </motion.button>
            ))}
