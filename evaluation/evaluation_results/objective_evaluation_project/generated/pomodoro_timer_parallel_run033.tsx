      ...
      intervalRef.current = setInterval(() => {
        setTimeLeft((prev) => {
          if (prev <= 1) {
            ...
            // Play completion sound (simple beep using Web Audio API)
    ...
    <div className={`min-h-screen relative overflow-hidden transition-all duration-1000 ${timerModes[currentMode].gradient}`}>
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-8">
        ...
        >
                ...
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 320 320">
                  ...
                  <defs>
                    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" className={`text-${currentMode === 'work' ? 'rose' : currentMode === 'shortBreak' ? 'cyan' : 'emerald'}-400`} stopColor="currentColor" />
                      <stop offset="50%" className={`text-${currentMode === 'work' ? 'pink' : currentMode === 'shortBreak' ? 'blue' : 'teal'}-400`} stopColor="currentColor" />
                      <stop offset="100%" className={`text-${currentMode === 'work' ? 'purple' : currentMode === 'shortBreak' ? 'indigo' : 'cyan'}-400`} stopColor="currentColor" />
                    </linearGradient>
                  </defs>
                </svg>
          ...
          <audio ref={audioRef} src="data:audio/wav;base64," />
        </motion.div>
      </div>
    </div>
  );
