                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {tableData.map((row, index) => (
                        ...
                        >
                          <td className="py-3 px-2 md:px-4 text-sm font-medium text-gray-900 dark:text-white">
                            {row.product}
                          </td>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <Card className="dark:bg-gray-900 dark:border-gray-800">
              <CardHeader>
                ...
                <CardDescription className="dark:text-gray-400">In-depth performance metrics</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="reports" className="space-y-6">
            <Card className="dark:bg-gray-900 dark:border-gray-800">
              <CardHeader>
                ...
                <CardDescription className="dark:text-gray-400">Download and view your reports</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {['Monthly Sales Report', 'Customer Analytics', 'Product Performance', 'Financial Summary'].map((report, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: index * 0.1 }}
                      className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg gap-3"
                    >
                      <div>
                        <h4 className="font-medium text-gray-900 dark:text-white">{report}</h4>
