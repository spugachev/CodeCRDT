  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 relative overflow-hidden">
      ...
      >
        ...
        />
        <motion.div
          className="absolute w-80 h-80 bg-yellow-300/20 rounded-full blur-3xl"
          animate={{
            x: [0, -150, 0],
            y: [0, 100, 0],
            scale: [1, 1.3, 1],
        ...
        />
        <motion.div
          className="absolute w-72 h-72 bg-pink-300/15 rounded-full blur-3xl"
          animate={{
            x: [0, 80, 0],
            y: [0, 120, 0],
            scale: [1, 1.1, 1],
        ...
        />
        <motion.div
          className="absolute w-64 h-64 bg-purple-300/20 rounded-full blur-3xl"
          animate={{
            x: [0, -100, 0],
            y: [0, -80, 0],
            scale: [1, 1.25, 1],
                    ...
                    >
                      ...
                      <div className="flex gap-1">
                        {[1, 2, 3, 4].map((bar) => {
                          ...
                          const isActive = bar <= Math.ceil(strength / 25);
                          return (
                            <motion.div
                              key={bar}
                              initial={{ scaleX: 0 }}
