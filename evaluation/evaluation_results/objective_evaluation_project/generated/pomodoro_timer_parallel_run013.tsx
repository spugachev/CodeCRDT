              ...
              >
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <Label htmlFor="work-duration" className="text-white/90 text-lg">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="short-break-duration" className="text-white/90 text-lg">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="long-break-duration" className="text-white/90 text-lg">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="long-break-interval" className="text-white/90 text-lg">
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      className="bg-white/30 hover:bg-white/40 text-white backdrop-blur-sm border border-white/40 px-8 py-3 text-lg"
                    >
                      Continue
                    </Button>
                  </motion.div>
