      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8">
        ...
        >
          ...
          <div className="relative backdrop-blur-2xl bg-white/5 rounded-full p-8 border border-white/10 shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <div className={`text-xl ${currentColors.text} font-medium uppercase tracking-wider`}>
        ...
        >
          ...
          <Button
            ...
            size="lg"
            variant="ghost"
            className="px-6 py-6 rounded-2xl backdrop-blur-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white"
          >
            <RotateCcw size={24} />
          </Button>
        ...
        >
          <div className="text-center">
            ...
            <div className="text-slate-400">Pomodoros Completed</div>
          </div>
        </motion.div>
