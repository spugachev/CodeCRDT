    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          className="space-y-2"
        >
          <Label htmlFor="short-break" className="text-white text-sm font-medium">
            Short Break (minutes)
          </Label>
          <Input
            id="short-break"
        ...
        <motion.div
          ...
          className="space-y-2"
        >
          <Label htmlFor="long-break" className="text-white text-sm font-medium">
            Long Break (minutes)
          </Label>
          <Input
            id="long-break"
            ...
            {showCompletion && (
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border-4 border-yellow-400 pointer-events-auto"
                >
                  <motion.div
                  ...
                  <p className="text-gray-600 text-center">
                    {currentMode === 'work' 
                      ? `Pomodoro #${completedPomodoros} completed!` 
                ...
                <audio
                  ref={audioRef}
                  src="data:audio/wav;base64,"
                />
              </motion.div>
            )}
          </AnimatePresence>
