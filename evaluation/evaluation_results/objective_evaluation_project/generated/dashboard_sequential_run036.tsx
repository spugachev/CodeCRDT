      ...
      <div className="container mx-auto p-4 md:p-6 lg:p-8">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
                ...
                <CardContent>
                  ...
                  <div className="mt-6 pt-6 border-t dark:border-gray-800">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-gray-900 dark:text-white">12,458</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="analytics">
            <Card className="dark:bg-gray-900 dark:border-gray-800">
              <CardHeader>
                <CardTitle className="dark:text-white">Advanced Analytics</CardTitle>
                <CardDescription className="dark:text-gray-400">Detailed performance metrics and insights</CardDescription>
              </CardHeader>
              <CardContent>
