...
const CompletionModal = ({ 
  ...
  const messages = {
    work: {
      title: '🎉 Great Work!',
      message: 'You completed a focus session. Time for a break!',
      emoji: '✨'
    },
    shortBreak: {
      title: '☕ Break Complete!',
      message: 'Feeling refreshed? Ready to focus again?',
      emoji: '💪'
    },
    longBreak: {
        ...
        >
          ...
          >
            ...
            <motion.h2
              ...
              className="text-3xl font-bold text-center mb-4 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent"
            >
