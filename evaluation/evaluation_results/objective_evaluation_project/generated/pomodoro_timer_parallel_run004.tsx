            ...
            {showCompletion && (
              ...
              >
                ...
                >
                  ...
                  <h2 className="text-4xl font-bold text-center mb-4 bg-gradient-to-r from-rose-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent">
                  ...
                  <Button
                    ...
                    size="lg"
                    className="w-full bg-gradient-to-r from-rose-500 via-purple-500 to-indigo-500 hover:opacity-90 text-white text-lg"
                  >
                    Continue
                  </Button>
                </motion.div>
